...
from google_ads_search_terms import main as google_ads_main
...
with DAG(
    dag_id="google_ads_search_terms_raw_dag",
    default_args=default_args,
    description="Incrementally extract and load Google Ads Search Terms data into BigQuery",
    ...
    run_incremental_extraction = PythonOperator(
        task_id="extract_and_load_google_ads_search_terms_raw_data",
